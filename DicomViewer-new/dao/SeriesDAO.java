...
//				studyTree.insertNodeInto(new DefaultMutableTreeNode(seriesColumns[1] + "[" + rs1.getString(2) + "]", false), parentNode, 1);
				studyTree.insertNodeInto(new DefaultMutableTreeNode(seriesColumns[2] + "[" + rs1.getString(3) + "]", false), parentNode, 1);
				studyTree.insertNodeInto(new DefaultMutableTreeNode(seriesColumns[3] + "[" + rs1.getString(4) + "]", false), parentNode, 2);
				studyTree.insertNodeInto(new DefaultMutableTreeNode(seriesColumns[4] + "[" + rs1.getString(5) + "]", false), parentNode, 3);
			}
