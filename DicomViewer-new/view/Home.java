...
public class Home implements ActionListener, Runnable {
	...
	private static DicomViewerController parserController;
	...
	private static void createAndShowGUI() {
		...
		DefaultTableModel dtmImage = new DefaultTableModel(
				new String[] { "Image UID", "Image Type", "Rows", "Columns", "Bits Allocated", "Bits Stored" }, 0);
		...
		btnDetails.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					javax.swing.JOptionPane.showMessageDialog(frame, "Please select the image details", "Dicom viewer",
							2);
				}
			}
		});
		...
		tPatientId.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				...
				try {
					...
					javax.swing.JOptionPane.showMessageDialog(frame, "' " + tPatientId.getText() + "'  Id not found ",
							"Dicom Viewer", 0);
				}
			...
			public void actionPerformed(java.awt.event.ActionEvent e) {
				...
				try {
					...
					javax.swing.JOptionPane.showMessageDialog(frame,
							"' " + tPatientName.getText() + "' : name not found ", "Dicom Viewer", 0);
				}
		...
		tDOB.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				...
				try {
					...
					javax.swing.JOptionPane.showMessageDialog(frame, "' " + tDOB.getText() + "' : DOB not found ",
							"Dicom Viewer", 0);
				}
		...
		tAccNumber.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				...
				try {
					...
					javax.swing.JOptionPane.showMessageDialog(frame,
							"' " + tAccNumber.getText() + "' : Accession number not found ", "Dicom Viewer", 0);
				}
		...
		tStudyId.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				...
				try {
					...
					javax.swing.JOptionPane.showMessageDialog(frame,
							"' " + tStudyId.getText() + "' : Study id not found ", "Dicom Viewer", 0);
				}
		...
		tStudyDateTime.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				...
				try {
					...
					javax.swing.JOptionPane.showMessageDialog(frame,
							"' " + tStudyDateTime.getText() + "'  : StudyDate and time not found ", "Dicom Viewer", 0);
				}
		...
		tStudyDecs.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				...
				try {
					...
					javax.swing.JOptionPane.showMessageDialog(frame,
							"' " + tStudyDecs.getText() + "' : Study description not found ", "Dicom Viewer", 0);
				}
			}
	...
	public static void dispSeries() {
		try {
			...
			studyId = String.valueOf(tPatient.getModel()
					.getValueAt(tPatient.getRowSorter().convertRowIndexToModel(tPatient.getSelectedRow()), 4));
			dtmSeries.isCellEditable(0, 0);
			List<Series> list;

			try {

				list = DicomViewerController.viewSeries(studyId);
	...
	public static void dispImage() {
		try {
			...
			try {
				...
				List<Image> list = DicomViewerController.viewImage(studyId, seriesId);
				for (int i = 0; i < list.size(); i++) {
	...
	public static void dispPatient() {
		...
		try {
			...
			list = DicomViewerController.viewAllPatientStudy();
			...
			javax.swing.JOptionPane.showMessageDialog(frame, "Study not found", "Dicom viewer", 2);
		}
	...
	public static void main(String args[]) throws InterruptedException, SecurityException, IOException {
		...
		Home t = new Home();
		parserController = new DicomViewerController(new DCMParser());
		new Thread(t).start();
		...
		if (ae.getActionCommand() == Actions.IMPORTFILE.name()) {
			...
			try {
				...
				if (f != null) {
					...
					DicomViewerController dbController = parserController.getDCMObj();
			...
			try {
				...
				if (directoryPath != null) {
					dcmfolder = new File(directoryPath);
					...
					for (File f : dcmfiles) {
						if (f.getName().endsWith(".dcm")) {
							...
							try {
								...
								javax.swing.JOptionPane.showMessageDialog(jf,
